  ...
  useEffect(() => {
    ...
    .then((result) => {
        if (result.data.Status) {
          setschooldata(result.data.Result);
...
const handleDelete = (id) => {
    ...
    .then(result => {
        if(result.data.Status) {
            ...
            setfilterschool(schooldata.filter(item => item.id !== id));
        } else {
            alert(result.data.Error)            
        }
      }).catch(err => {
...
const handleSearchchange = (a) =>{
  ...
  const filterschool = schooldata.filter((e)=>
                          ...
                          <div className="card-body">
                            <div className="box-header with-border">
                              <div className="box_add">  
                                <button><Link to='/display/add_location'>New Location</Link></button>
                              </div>
                                      ...
                                      <Link
                                       onClick={() => {
                                        ...
                                        if (isConfirmed) {
                                          ...
                                          window.location.href = `/display/edit_school/${attendance.id}`;
                                        }
                                      }}
                                        title="Edit"
